...
Как видим `Django` может автоматически загружать изображения, в папку
по указанному пути, но для такой загрузки требуется определить 2 
константы в настройках проекта. 
